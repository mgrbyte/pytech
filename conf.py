...
#
# An estimate of how long it will take to read the post.
# {reading_time}
#
# An estimate of how long it will take to read the post, sans the teaser.
# {remaining_reading_time}
#
# The string “{remaining_reading_time} min remaining to read”
# in the current language.
# {min_remaining_read}
#
# The amount of paragraphs in the post.
# {paragraph_count}
#
...
CONTENT_FOOTER = """
<div>
  <small>Contents &copy; {date} </small>
  <a href="mailto:{email}">{author}</a> |
  <a href="https://github.com/mgrbyte">github</a> |
  <a href="https://twitter.com/mgrbyte">twitter</a> |
  <a href="https://gratipay.com/mgrbyte/">gittip</a>
</div>
"""
...
# List of files relative to the server root (!)
# that will be asked to be excluded
# from indexing and other robotic spidering.
# * is supported. Will only be effective
# if SITE_URL points to server root. The list is used to exclude resources from
# /robots.txt and /sitemap.xml, and to inform search engines
# about /sitemapindex.xml.
...
#        maxlength="255" results="0" placeholder="Search"/>
# </form>
# <!-- End of custom search -->
# """ % SITE_URL
